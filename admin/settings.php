...
<div class="grid-2">
    <div class="card">
        ...
        <form method="post">
            <?php echo csrf_input(); ?>
            <div class="list">
                <label class="item"><input type="checkbox" name="enable_map_features" value="1" <?php echo $mapEnabled ? 'checked' : ''; ?> style="margin-right:8px">เปิดฟีเจอร์แผนที่และการมาร์คจุดส่ง</label>
                <label class="item"><input type="checkbox" name="enable_delivery_rounds" value="1" <?php echo $roundsEnabled ? 'checked' : ''; ?> style="margin-right:8px">เปิดรอบการส่ง</label>
                <label class="item"><input type="checkbox" name="enable_route_labels" value="1" <?php echo $routeLabelsEnabled ? 'checked' : ''; ?> style="margin-right:8px">เปิดสาย/โซนส่ง</label>
                <label class="item"><input type="checkbox" name="enable_delivery_order" value="1" <?php echo $deliveryOrderEnabled ? 'checked' : ''; ?> style="margin-right:8px">เปิดลำดับการส่ง</label>
                <label class="item"><input type="checkbox" name="enable_quick_tools" value="1" <?php echo $quickToolsEnabled ? 'checked' : ''; ?> style="margin-right:8px">เปิดเครื่องมือเร็ว</label>
            </div>
            <div class="btn-row"><button type="submit" name="save_flags" value="1" class="btn btn-primary">บันทึกการตั้งค่า</button></div>
        </form>
    </div>
    <div class="card">
